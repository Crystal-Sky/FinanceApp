...
public class MonthRecord extends AppCompatActivity {
    //添加
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.month_record);
        mToolbar = (Toolbar) findViewById(R.id.toolbar_month);
        mToolbar.setTitle("");
        ...
        double InSum=indb.MonthInSum();
        double OutSum=outdb.MonthOutSum();
        ...
        ListView listView = (ListView) findViewById(R.id.month_record_listview);
        ListViewAdapter listAdapter = new ListViewAdapter(this);
        listView.setAdapter(listAdapter);
        //Log.d("qwe", "qwe----position:value -");
        List<TListItem> List=new ArrayList<>();
        List<InObject> list=indb.queryMonth();
        List<OutObject> listOut=outdb.queryMonth();
