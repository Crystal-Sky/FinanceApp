...
public class WeekRecord extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.week_record);
        mToolbar = (Toolbar) findViewById(R.id.toolbar_week);
        mToolbar.setTitle("");
        ...
        double InSum=indb.WeekInSum();
        double OutSum=outdb.WeekOutSum();
        ...
        ListView listView = (ListView) findViewById(R.id.week_record_listview);
        ListViewAdapter listAdapter = new ListViewAdapter(this);
        listView.setAdapter(listAdapter);
        //Log.d("qwe", "qwe----position:value -");
        List<TListItem> List=new ArrayList<>();
        List<InObject> list=indb.queryWeek();
        List<OutObject> listOut=outdb.queryWeek();
