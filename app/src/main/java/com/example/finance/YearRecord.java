...
public class YearRecord extends AppCompatActivity {
    //添加
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.year_record);
        mToolbar = (Toolbar) findViewById(R.id.toolbar_year);
        mToolbar.setTitle("");
        ...
        double InSum=indb.YearInSum();
        double OutSum=outdb.YearOutSum();
        ...
        ListView listView = (ListView) findViewById(R.id.year_record_listview);
        ListViewAdapter listAdapter = new ListViewAdapter(this);
        listView.setAdapter(listAdapter);
        //Log.d("qwe", "qwe----position:value -");
        List<TListItem> List=new ArrayList<>();
        List<InObject> list=indb.queryYear();
        List<OutObject> listOut=outdb.queryYear();
